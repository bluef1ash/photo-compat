...
Section Uninstall
  ...
  !insertmacro UnpinShortcut "$SMPROGRAMS\$AppStartMenuFolder\照片适配助手.lnk"
  !insertmacro UnpinShortcut "$DESKTOP\照片适配助手.lnk"

  ; Remove start menu shortcut
  !insertmacro MUI_STARTMENU_GETFOLDER Application $AppStartMenuFolder
  Delete "$SMPROGRAMS\$AppStartMenuFolder\照片适配助手.lnk"
  RMDir "$SMPROGRAMS\$AppStartMenuFolder"

  ; Remove desktop shortcuts
  Delete "$DESKTOP\照片适配助手.lnk"
...
Function CreateDesktopShortcut
  CreateShortcut "$DESKTOP\照片适配助手.lnk" "$INSTDIR\${MAINBINARYNAME}.exe"
  !insertmacro SetLnkAppUserModelId "$DESKTOP\照片适配助手.lnk"
FunctionEnd

Function CreateStartMenuShortcut
  CreateDirectory "$SMPROGRAMS\$AppStartMenuFolder"
  CreateShortcut "$SMPROGRAMS\$AppStartMenuFolder\照片适配助手.lnk" "$INSTDIR\${MAINBINARYNAME}.exe"
  !insertmacro SetLnkAppUserModelId "$SMPROGRAMS\$AppStartMenuFolder\照片适配助手.lnk"
FunctionEnd
